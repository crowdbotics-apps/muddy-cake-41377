"""
Django settings for muddy_cake_41377 project.
...
ROOT_URLCONF = 'muddy_cake_41377.urls'
...
WSGI_APPLICATION = 'muddy_cake_41377.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "muddy_cake_41377 API",
    "DESCRIPTION": "API documentation for muddy_cake_41377 App",
    "VERSION": "v1",
}
